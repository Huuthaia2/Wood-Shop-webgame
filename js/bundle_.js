...
! function() {
    ...
    class f extends t.GameSceneUI {
        constructor() {
            ...
            e.transform.position = new Laya.Vector3(0, -100, 1), e.transform.localPositionX = -65,
                ...
                this.paintBtn.on(Laya.Event.CLICK, this, this.paintClick), this.skinBtn.on(Laya.Event.CLICK, this, this.onClick, [1]),
                this.settingBtn.on(Laya.Event.CLICK, this, this.onClick, [2]),
                this.startBtn.on(Laya.Event.CLICK, this, this.onClick, [3]),
                this.rankBtn.on(Laya.Event.CLICK, this, this.onClick, [4]), this.returnBtn.on(Laya.Event.CLICK, this, this.onClick, [5]),
        ...
        onClick(t, e) {
            ...
            else if (4 == t) r.getIns().sceneOpen("RankDialog.scene");
            else if (5 == t) {
                this.changeGameSt(0);
    ...
    new class {
        ...
        loadSubPack() {
            ...
            // o.gamedistributionID = "833056b1e0c74324be1898deecfb51dc";
